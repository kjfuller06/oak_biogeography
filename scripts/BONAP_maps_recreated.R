...
# Q. stellata ####
# generate county maps from manual copy of BONAP maps
ste_cmn_bonap = selectFeatures(counties)
ste_rare_bonap = selectFeatures(counties)
ste_cmn_bonap$rarity = "common"
ste_rare_bonap$rarity = "rare"
ste_bonap = rbind(ste_cmn_bonap, ste_rare_bonap)
write_sf(ste_bonap, "outputs/Qste_bonap.shp")

# Q. velutina ####
# generate county maps from manual copy of BONAP maps
vel_cmn_bonap = selectFeatures(counties)
vel_cmn_bonap$rarity = "common"
vel_bonap = vel_cmn_bonap
write_sf(vel_bonap, "outputs/Qvel_bonap.shp")

# Q. virginiana ####
# generate county maps from manual copy of BONAP maps
vir_cmn_bonap = selectFeatures(counties)
vir_rare_bonap = selectFeatures(counties)
vir_int_bonap = selectFeatures(counties)
vir_cmn_bonap$rarity = "common"
vir_rare_bonap$rarity = "rare"
vir_int_bonap$rarity = "introduced"
vir_bonap = rbind(vir_cmn_bonap, vir_rare_bonap)
vir_bonap = rbind(vir_bonap, vir_int_bonap)
write_sf(vir_bonap, "outputs/Qvir_bonap.shp")
